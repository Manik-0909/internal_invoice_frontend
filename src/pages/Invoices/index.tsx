...
const Invoices = ({ fileUrl }: InvoicesProps): React.ReactNode => {
  ...
  return (
    <>
      <div className="bg-gradient-effect min-h-screen pb-5 md:pb-10">
                              ...
                              <div className="overflow-hidden">
                                <table className="text-surface min-w-full">
                                  ...
                                  <tbody>
                                    ...
                                    <tr className="hidden border-t border-transparent">
                                      <td className="py-2 text-left text-sm whitespace-nowrap">
                                        Extracted
                                      </td>
        ...
        <div className="space-y-2">
          <button
            type="button"
            className="bg-primary shadow-primary-3 hover:bg-primary-accent-300 hover:shadow-primary-2 focus:bg-primary-accent-300 focus:shadow-primary-2 active:bg-primary-600 active:shadow-primary-2 dark:hover:shadow-dark-strong dark:focus:shadow-dark-strong dark:active:shadow-dark-strong inline-block rounded px-6 pt-2.5 pb-2 text-xs leading-normal font-medium uppercase transition duration-150 ease-in-out focus:ring-0 focus:outline-none dark:shadow-black/30"
            data-twe-toggle="modal"
            data-twe-target="#flagReviewModal"
            data-twe-ripple-init
            data-twe-ripple-color="light"
              ...
              <div className="flex shrink-0 items-start justify-between rounded-t-xl p-4">
                <div>
                  ...
                  <p className="mt-1 text-xs text-neutral-500">
                    This invoice requires manual processing outside the
                    automated workflow.
                  </p>
                </div>
                <button
